 ...
 * Cada test tiene un banco (pool) más grande que el número de preguntas que se
 * muestran: en cada intento se barajan y se eligen `pick` preguntas, de modo que
 * el test va cambiando entre una vez y otra.
 *
 * Tipos:
 *   - 'quiz'  -> preguntas con una respuesta correcta (index `correct`).
...
(function () {
  ...
  const TESTS = {
    ...
    iq: {
      ...
      icon: '🧠',
      tag: 'Cognitivo',
      description: 'Lógica, matemáticas, patrones y razonamiento verbal.',
      type: 'quiz',
      timeLimit: 600,
      pick: 20,
      scoring: 'iq',
      pool: [
        { category: 'Lógica', text: 'Completa la secuencia: 2, 4, 8, 16, ?', options: ['24', '30', '32', '20'], correct: 2 },
        { category: 'Lógica', text: 'Todos los Bloops son Razzles. Todos los Razzles son Lazzles. ¿Todos los Bloops son necesariamente Lazzles?', options: ['Sí, siempre', 'No, nunca', 'Solo a veces', 'No hay información suficiente'], correct: 0 },
        { category: 'Lógica', text: 'Ana es más alta que Bruno. Carla es más baja que Bruno. ¿Quién es el más bajo de los tres?', options: ['Ana', 'Bruno', 'Carla', 'No se puede saber'], correct: 2 },
        { category: 'Lógica', text: '¿Qué número no pertenece al grupo? 3, 5, 7, 10, 11', options: ['3', '7', '10', '11'], correct: 2 },
        { category: 'Lógica', text: 'Si hoy es miércoles, ¿qué día será dentro de 100 días?', options: ['Jueves', 'Viernes', 'Sábado', 'Domingo'], correct: 1 },
        { category: 'Lógica', text: 'Si algunos gatos son negros y todos los negros son rápidos, ¿qué es seguro?', options: ['Todos los gatos son rápidos', 'Algunos gatos son rápidos', 'Ningún gato es rápido', 'Todos los rápidos son gatos'], correct: 1 },
        { category: 'Lógica', text: 'Un reloj marca las 3:15. ¿Qué ángulo forman las agujas (aprox.)?', options: ['0°', '7,5°', '30°', '45°'], correct: 1 },
        { category: 'Lógica', text: '¿Qué figura completa la analogía? Guante es a mano como zapato es a...', options: ['Calcetín', 'Pie', 'Suela', 'Cordón'], correct: 1 },
        { category: 'Matemáticas', text: '¿Cuánto es 15 × 3 − 8?', options: ['31', '37', '45', '52'], correct: 1 },
        { category: 'Matemáticas', text: 'Completa la serie de Fibonacci: 1, 1, 2, 3, 5, 8, ?', options: ['11', '12', '13', '14'], correct: 2 },
        { category: 'Matemáticas', text: 'Una camiseta cuesta 80€ tras un descuento del 20%. ¿Cuál era el precio original?', options: ['90€', '96€', '100€', '110€'], correct: 2 },
        { category: 'Matemáticas', text: '¿Cuánto es 7² − 6²?', options: ['1', '7', '13', '49'], correct: 2 },
        { category: 'Matemáticas', text: 'Un tren recorre 60 km en 45 minutos. ¿Cuál es su velocidad en km/h?', options: ['60 km/h', '75 km/h', '80 km/h', '90 km/h'], correct: 2 },
        { category: 'Matemáticas', text: 'Si 3 obreros construyen un muro en 6 horas, ¿cuánto tardarán 6 obreros al mismo ritmo?', options: ['2 horas', '3 horas', '4 horas', '12 horas'], correct: 1 },
        { category: 'Matemáticas', text: '¿Cuál es el 25% de 240?', options: ['48', '60', '72', '80'], correct: 1 },
        { category: 'Matemáticas', text: 'Serie: 100, 50, 25, 12,5, ?', options: ['6', '6,25', '8', '5'], correct: 1 },
        { category: 'Patrones', text: 'Completa la secuencia de letras: A, C, E, G, ?', options: ['H', 'I', 'J', 'F'], correct: 1 },
        { category: 'Patrones', text: 'Completa la serie numérica: 2, 6, 12, 20, 30, ?', options: ['36', '40', '42', '44'], correct: 2 },
        { category: 'Patrones', text: 'Sigue el patrón: Círculo, Cuadrado, Triángulo, Círculo, Cuadrado, ?', options: ['Círculo', 'Cuadrado', 'Triángulo', 'Rombo'], correct: 2 },
        { category: 'Patrones', text: 'Completa la secuencia: 1, 4, 9, 16, 25, ?', options: ['30', '32', '36', '49'], correct: 2 },
        { category: 'Patrones', text: 'Completa la secuencia de letras: Z, Y, X, W, ?', options: ['U', 'V', 'T', 'S'], correct: 1 },
        { category: 'Patrones', text: 'Serie: 3, 6, 5, 10, 9, 18, ?', options: ['16', '17', '20', '27'], correct: 1 },
        { category: 'Patrones', text: '¿Qué número sigue? 1, 2, 4, 7, 11, ?', options: ['14', '15', '16', '18'], correct: 2 },
        { category: 'Patrones', text: 'Completa: AZ, BY, CX, ?', options: ['DV', 'DW', 'EW', 'DX'], correct: 1 },
        { category: 'Verbal', text: 'Perro es a Cachorro como Gato es a...', options: ['Felino', 'Gatito', 'Maullido', 'Ratón'], correct: 1 },
        { category: 'Verbal', text: '¿Cuál es el antónimo de "efímero"?', options: ['Fugaz', 'Breve', 'Duradero', 'Instantáneo'], correct: 2 },
        { category: 'Verbal', text: 'Libro es a Leer como Comida es a...', options: ['Cocinar', 'Comer', 'Cortar', 'Servir'], correct: 1 },
        { category: 'Verbal', text: '¿Cuál es el sinónimo de "locuaz"?', options: ['Callado', 'Tímido', 'Hablador', 'Sereno'], correct: 2 },
        { category: 'Verbal', text: 'Médico es a Hospital como Profesor es a...', options: ['Libro', 'Escuela', 'Alumno', 'Pizarra'], correct: 1 },
        { category: 'Verbal', text: '¿Qué palabra no encaja con las demás?', options: ['Rosa', 'Tulipán', 'Roble', 'Margarita'], correct: 2 },
        { category: 'Verbal', text: '¿Cuál es el antónimo de "prudente"?', options: ['Cauto', 'Sensato', 'Temerario', 'Discreto'], correct: 2 },
        { category: 'Verbal', text: 'Pintor es a Pincel como Escritor es a...', options: ['Papel', 'Pluma', 'Novela', 'Idea'], correct: 1 }
      ]
    },
    ...
    estres: {
      ...
      invertHeadline: true, // más puntuación = más estrés = peor
    ...
    atencion: {
      ...
      scoring: 'percent',
      pool: [
        { category: 'Atención', text: '¿Cuántas veces aparece la letra «a» en: «Ana canta una canción»?', options: ['4', '5', '6', '7'], correct: 2 },
        { category: 'Atención', text: '¿Cuál no encaja? 121, 144, 169, 150, 196', options: ['121', '150', '169', '196'], correct: 1 },
        { category: 'Atención', text: '¿Cuántos «7» hay en la serie? 7 1 7 4 7 9 2 7 5 7', options: ['4', '5', '6', '3'], correct: 1 },
        { category: 'Atención', text: 'Si la palabra ROJO está escrita en tinta azul, ¿de qué color es la tinta?', options: ['Rojo', 'Azul', 'Verde', 'Negro'], correct: 1 },
        { category: 'Atención', text: '¿Cuál es el siguiente? 3, 6, 9, 12, ?', options: ['13', '14', '15', '18'], correct: 2 },
        { category: 'Atención', text: '¿Cuál de estas palabras está escrita incorrectamente?', options: ['Aeropuerto', 'Aereopuerto', 'Almohada', 'Zanahoria'], correct: 1 },
        { category: 'Atención', text: 'En la secuencia B, D, F, H, ¿qué letra sigue?', options: ['I', 'J', 'K', 'G'], correct: 1 },
        { category: 'Atención', text: '¿Cuántas vocales tiene la palabra «MURCIÉLAGO»?', options: ['4', '5', '6', '3'], correct: 1 },
        { category: 'Atención', text: 'Rápido: 8 × 7 = ?', options: ['54', '56', '63', '48'], correct: 1 },
        { category: 'Atención', text: '¿Qué número falta? 2, 4, __, 8, 10', options: ['5', '6', '7', '3'], correct: 1 },
        { category: 'Atención', text: '¿Cuál es el mayor? 0,7 · 0,68 · 0,702 · 0,79', options: ['0,7', '0,68', '0,702', '0,79'], correct: 3 },
        { category: 'Atención', text: 'Lee con atención: «Todos menos Juan aprobaron». ¿Quién NO aprobó?', options: ['Todos', 'Juan', 'Nadie', 'No se sabe'], correct: 1 },
        { category: 'Atención', text: '¿Cuántas letras «e» hay en «excelente experiencia»?', options: ['6', '7', '8', '5'], correct: 1 },
        { category: 'Atención', text: 'Serie: 1, 2, 4, 7, 11, ?', options: ['14', '15', '16', '18'], correct: 2 },
        { category: 'Atención', text: '¿Cuál es distinto? gato, perro, león, mesa, caballo', options: ['gato', 'león', 'mesa', 'caballo'], correct: 2 }
      ]
    }

  };

  // Orden en que se muestran en la portada.
  const TEST_ORDER = ['bigfive', 'eq', 'vark', 'estres', 'atencion', 'iq'];
